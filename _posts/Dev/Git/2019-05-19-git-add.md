...
#### 1. git status <br>
  ...
  ![git add 1](https://krispediadot.github.io/assets/images/git_add_1.jpg)

#### 2. 실습에 사용할 폴더를 생성해봅시다.<br>

  vim 으로 newfile.txt 파일을 만들겠습니다.

  ![git add 2](https://krispediadot.github.io/assets/images/git_add_2.jpg)

  (1).키보드 i = insert mode<br>
  (2).파일 작성<br>
  (3).esc키 + :wq 로 저장합니다.<br> 

  ![git add 3](https://krispediadot.github.io/assets/images/git_add_3.jpg)

  작성 후 master 뒤 체크 이모티콘이 X로 변하는 것을 확인할 수 있습니다.<br> 

  git status로 어떤 상황인지 확인해봅시다.<br>

  ![git add 4](https://krispediadot.github.io/assets/images/git_add_4.jpg)
...
#### 3. git add <파일 이름>  <br>
  ...
  ![git add 5](https://krispediadot.github.io/assets/images/git_add_5.jpg)
...
#### 4. git rm --cached  <br>
  ...
  ![git add 6](https://krispediadot.github.io/assets/images/git_add_6.jpg)<br>

  newfile.txt가 tracking 될 수 있도록 다시 add해놓겠습니다. <br>

  ![git add 7](https://krispediadot.github.io/assets/images/git_add_7.jpg)<br>
...
#### 5. git add. <br>
  ...
  ![git add 8](https://krispediadot.github.io/assets/images/git_add_8.jpg)<br>

  ![git add 9](https://krispediadot.github.io/assets/images/git_add_9.jpg)<br>

  ![git add 10](https://krispediadot.github.io/assets/images/git_add_10.jpg)<br>

  ls 명령어로 확인 해 보면 new1.py와 new2.txt 파일이 생성된걸 볼 수 있습니다. 

  ![git add 11](https://krispediadot.github.io/assets/images/git_add_11.jpg)<br>

  new1.py & new2.txt 파일이 untracked files로 분류되어 있습니다. <br>
  git add. 로 한번에 두개의 파일을 add 해봅니다.<br>

  ![git add 12](https://krispediadot.github.io/assets/images/git_add_12.jpg)<br>
...
[[Git+] git add](https://krispediadot.github.io/git+-add)